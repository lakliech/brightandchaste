  ...
  <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-28">
      ...
      <a href="#home" class="flex items-center">
        <img src="/static/logo.png" alt="Bright and Chaste Limited" class="h-24 w-auto brightness-0 invert" />
      </a>
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
      ...
      <div class="lg:col-span-1">
        <a href="#home" class="flex items-center mb-5">
          <img src="/static/logo.png" alt="Bright and Chaste Limited" class="h-20 w-auto brightness-0 invert" />
        </a>
